...
const EarthRadius = 6370000;
const WrfProjections = {
    lambert: 'lambert',
    mercator: 'mercator',
    polar: 'polar',
    latlon: 'latlon',
...
export class WrfProjection {
    ...
    constructor(params) {
        ...
        this._transformTo = proj4(WrfProjection._wrf_proj, this._proj4);
        this._transformFrom = proj4(this._proj4, WrfProjection._wrf_proj);
    }
    ...
    latlon_to_ij(lat, lon) {
        ...
        var toReturn = this._transformTo.forward([lon, lat]);
    ...
    ij_to_latlon(i, j) {
        ...
        var toReturn = this._transformFrom.forward([i, j]);
